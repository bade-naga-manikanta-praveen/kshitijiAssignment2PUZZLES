...
function CLICK2(){
    ...
    currTile2=this;
    if(currTile2.src === "https://bade-naga-manikanta-praveen.github.io/kshitijiAssignment2PUZZLES/15.jpg"){
        return;
    }
    for(let l=0;l<25;l++){
        if(tile2[l].src === "https://bade-naga-manikanta-praveen.github.io/kshitijiAssignment2PUZZLES/15.jpg"){
            otherTile2=tile2[l];
            break;
        }
    }
 ...
 document.getElementById(ele_r.toString()+","+ele_c.toString()).innerHTML=" ";
    ...
    for(let r=0;r<rows2;r++){
        for(let c=0;c<columns2;c++){
            ...
            tile2[flag3_2].src= ("1"+b.shift()).toString() + ".jpg";
